...
/**
 * A basic implementation of {@link org.apache.lucene.spatial.prefix.PrefixTreeStrategy} using a large
 * {@link org.apache.lucene.queries.TermsQuery} of all the cells from
 * {@link org.apache.lucene.spatial.prefix.tree.SpatialPrefixTree#getTreeCellIterator(com.spatial4j.core.shape.Shape, int)}.
...
public class TermQueryPrefixTreeStrategy extends PrefixTreeStrategy {
  ...
  public Filter makeFilter(SpatialArgs args) {
    ...
    QueryParseContext context = new QueryParseContext(null, null);
    TermsQuery tq = new TermsQuery(getFieldName(), terms);
    return Queries.wrap(tq, context);
  }
