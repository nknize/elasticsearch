...
public class GeoShapeFieldMapper extends AbstractGeometryFieldMapper<Geometry, Geometry> {
    ...
    public interface CRSHandler {
        ...
        Object newTransform(Object targetCRS);
        double[] reproject(double x, double y, Object transform);
    }
    ...
    protected static class DefaultCRSHandler implements CRSHandler {
        ...
        @Override
        public Object newTransform(Object targetCRS) {
            throw new ElasticsearchException("getCRS not supported for default CRSHandler");
        }

        public double[] reproject(double x, double y, Object transform) {
